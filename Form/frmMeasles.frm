...
Begin VB.Form frmMeasles 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Measles Level"
   ClientHeight    =   5640
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   4110
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMeasles.frx":0000
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmMeasles"
...
With rs
        .AddNew
        !Measles = Me.txtDescription.Text
        .Update
End With
...
With lstCategory
    ...
    .ColumnHeaders.Add , , "Measles-Level", 4250
End With
Set rs = New ADODB.Recordset
rs.Open "Select * from tbl_MeaslesLevel ", cn, 1, 2
...
Do Until rs.EOF
With rs
    Set lst = lstCategory.ListItems.Add(, , !MeaslesID)
        lst.ListSubItems.Add , , !Measles, 1, 1
...
Set rs = New ADODB.Recordset
rs.Open "Select * from tbl_MeaslesLevel where MeaslesID like '" & Me.txtCategory.Text & "'", cn, 1, 2
With rs
