...
Begin VB.Form frmMalaria 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Malaria Level"
   ClientHeight    =   5610
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   4200
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMalaria.frx":0000
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmMalaria"
...
With rs
        .AddNew
        !Malaria = Me.txtDescription.Text
        .Update
End With
...
With lstCategory
    ...
    .ColumnHeaders.Add , , "Malaria-Level", 4250
End With
Set rs = New ADODB.Recordset
rs.Open "Select * from tbl_MalariaLevel ", cn, 1, 2
...
Do Until rs.EOF
With rs
    Set lst = lstCategory.ListItems.Add(, , !MalariaID)
        lst.ListSubItems.Add , , !Malaria, 1, 1
...
Set rs = New ADODB.Recordset
rs.Open "Select * from tbl_MalariaLevel where MalariaID like '" & Me.txtCategory.Text & "'", cn, 1, 2
With rs
