...
Begin VB.Form frmDengue 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Dengue Level"
   ClientHeight    =   5640
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   4125
...
With lstCategory
    ...
    .ColumnHeaders.Add , , "Dengue-Level", 4250
End With
Set rs = New ADODB.Recordset
rs.Open "Select * from tbl_DengueLevel ", cn, 1, 2
...
Do Until rs.EOF
With rs
    Set lst = lstCategory.ListItems.Add(, , !DengueID)
        lst.ListSubItems.Add , , !Dengue, 1, 1
...
Set rs = New ADODB.Recordset
rs.Open "Select * from tbl_DengueLevel where DengueID like '" & Me.txtCategory.Text & "'", cn, 1, 2
With rs
